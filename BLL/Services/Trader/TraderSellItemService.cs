...
{
    public class TraderSellItemService
    {
        public static List<RequestTableItemDTO> Add(List<RequestTableItemDTO> s)
        {
            ...
            var checkitem = DataAccessFactoryTrader.TradersellandColdStorageRequestData().GetSinle(reqid);
            if (checkitem == null)
            {
            ...
            else if (checkitem.RequestType != "Buy")
            {
            ...
            var addedData = DataAccessFactoryTrader.TraderAddSellItemtotheRequestItemData().Create(data);
        ...
        {
            var checkrequest = DataAccessFactoryTrader.TraderAddSellItemtotheRequestItemData().Get(id1);
            ...
            var checkitem = DataAccessFactoryTrader.TradersellandColdStorageRequestData().GetSinle(requestId);
            ...
            return DataAccessFactoryTrader.TraderAddSellItemtotheRequestItemData().Delete(id1);
        }
        ...
        public static List<RequestTableItemDTO> UpdateData(List<RequestTableItemDTO> s, int userid)
        {
            ...
            var addedData = DataAccessFactoryTrader.TraderAddSellItemtotheRequestItemData().Update(data);
            var config2 = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<RequestTableItem, RequestTableItemDTO>();
            });
        ...
        {
            var data = DataAccessFactoryTrader.TraderAddSellItemtotheRequestItemData().Get(Id);
        ...
        {
            var data = DataAccessFactoryTrader.TraderAddSellItemtotheRequestItemData().GetSingleItem(id, requestId);
