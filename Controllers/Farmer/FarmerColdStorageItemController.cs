...
namespace Fair_Farm.Controllers.Farmer
{
    public class FarmerColdStorageItemController : ApiController
    {
        ...
        /*[FarmerAccess]*/
        [HttpPost]
        [Route("api/farmercoldstorageitem/create")]
        ...
        /*[FarmerAccess]*/
        [HttpDelete]
        [Route("api/farmercoldstorageitem/{id1}/{userid}")]
        ...
        /*[FarmerAccess]*/
        [HttpPut]
        [Route("api/farmercoldstorageitemupdatemultiple/update/{userid}")]
        ...
        /*[Logged]*/
        [HttpGet]
        [Route("api/farmercoldstorageitemunderasinglerequest/{requestid}")]
        ...
        /*[Logged]*/
        [HttpGet]
        [Route("api/farmercoldstorageitemgetitbyasingletableid/{id}/{requestid}")]
