...
namespace Fair_Farm.Controllers.Farmer
{
    public class FarmerSellItemController : ApiController
    {
        ...
        /*[FarmerAccess]*/
        [HttpPut]
        [Route("api/farmersellandcoldstorageitemupdatemultiple/update/{userid}")]
        ...
        /*[Logged]*/
        [HttpGet]
        [Route("api/farmersellandcoldstorageitemgetitemunderasinglerequest/{requestid}")]
        ...
        /*[Logged]*/
        [HttpGet]
        [Route("api/farmersellandcoldstorageitemgetitbyasingletableid/{id}/{requestid}")]
